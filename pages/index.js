...
import { MyComponent } from "@/component/select";
        ...
        <div className="flex-col w-full h-fit  ">
          <div className="flex w-full  items-center justify-center gap-0 text-center ">
            <div className="w-4/12 h-10 flex text-center items-center justify-center j text-bold text-xl border border-black font-bold ">
              <button type="button" onClick={handleClick} className="text-black text-bold text-xl">
                Collection
              </button>
            </div>
            <div className="w-4/12 h-10 flex text-center items-center justify-center  border-32 text-xl border border-black font-bold">
              <button type="button"> <a href="https://www.instagram.com/newdawnsupply/?igshid=Zjc2ZTc4Nzk%3D"  className="text-black text-bold text-xl"> Contact</a>
              </button>
            </div>
            <div className="w-4/12 h-10 flex  border text-xl text-center border-black font-bold z-10">
             <select className="w-full h-full flex bg-white text-xl text-center font-bold text-black font-bold">
                <option>About</option>
          ...
          <div className="flex font-bold text-3xl items-center justify-center gap-3 w-full h-full pt-12 text-black font-bold">
            <SvgBasket />
            <p>Shop Now!</p>
          </div>
